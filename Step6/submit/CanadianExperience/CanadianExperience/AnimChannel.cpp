...
* indices.
* 
* \param currFrame the frame being set
*/
...
void CAnimChannel::DeleteKeyframe()
{
    ...
    if (mKeyframe1 != -1 && mKeyframes[mKeyframe1]->GetFrame() == currFrame)
    {
    ...
    if (mKeyframe2 != -1 && mKeyframes[mKeyframe2]->GetFrame() == currFrame)
    {
        mKeyframes.erase(mKeyframes.begin() + mKeyframe2);
        mKeyframe2--;
