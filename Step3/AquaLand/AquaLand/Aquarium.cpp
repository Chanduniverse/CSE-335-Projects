...
/**
 * Draw the aquarium and make them blush
...
void CAquarium::XmlItem(const std::shared_ptr<xmlnode::CXmlNode>& node)
{
    ...
    else if (type == L"bashful")
    {
        item = make_shared<CFishBashful>(this);
    }
    else if (type == L"neontetra")
    {
        item = make_shared<CFishNeonTetra>(this);
    }
