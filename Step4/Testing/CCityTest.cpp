...
namespace Testing
{
    ...
    {
    public:
        virtual void VisitBuilding(CTileBuilding* road) override { mNumBuilds++; }
        virtual void VisitCoalmine(CTileCoalmine* road) override { mNumMines++; }
        virtual void VisitLandscape(CTileLandscape* road) override { mNumLands++; }
