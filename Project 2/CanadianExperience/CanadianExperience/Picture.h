...
public:
    ...
    * \param size The new picture size */
    ...
    /** Get Dialog */
    void GetDialog() { mMachine->GetDialog(); UpdateObservers(); }

    /** Set Machine
     * \param machine */
    void SetMachine(std::shared_ptr<CMachineDrawable> machine) { mMachine = machine; }
...
private:
    ...
    /// The Machine
    std::shared_ptr<CMachineDrawable> mMachine = nullptr;
